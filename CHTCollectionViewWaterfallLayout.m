...
- (void)prepareLayout {
    ...
    for (NSInteger section = 0; section < numberOfSections; ++section) {
        ...
        if (headerHeight > 0) {
            ...
            top = CGRectGetMaxY(attributes.frame) + headerInset.bottom + sectionInset.top;
            for (idx = 0; idx < self.columnCount; idx++) {
        ...
        if (footerHeight > 0) {
            ...
            top = [self.columnHeights[columnIndex] floatValue] - minimumInteritemSpacing + sectionInset.bottom + footerInset.bottom;
